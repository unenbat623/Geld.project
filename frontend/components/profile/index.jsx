          ...
          <div className="flex justify-center pl-[30px] pr-[20px] w-96 items-center rounded-2xl bg-[#F6F6F7]">
            <div className="flex flex-col items-start gap-2">
              ...
              <div className="pt-2 items-center flex-col justify-center text-3xl pb-1">
                ...
                <h1 className="text-lg flex justify-center ml-16 text-[#0166FF]">
              ...
              <div className="">
                <p className=" text-2xl my-3 text-[#0166FF]">Desciption</p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio
                eaque, quidem, obcaecati quod dolorum sint alias, possimus illum
